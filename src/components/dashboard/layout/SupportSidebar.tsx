...
const NAV_ITEMS: SupportNavItem[] = [
  ...
  },
  {
    ...
    href: "/dashboard/support-dashboard/ai-command-center",
    icon: Radar,
    description: "AI operations health & signals",
  },
  {
    label: "AI Cases",
    href: "/dashboard/support-dashboard/ai-cases",
    icon: BrainCircuit,
    description: "Evidence-backed case workspace",
  },
  {
    label: "AI Alerts",
    href: "/dashboard/support-dashboard/ai-alerts",
    icon: BellRing,
    description: "Proactive failure spike alerts",
  },
  {
    label: "AI Incidents",
    href: "/dashboard/support-dashboard/ai-incidents",
    icon: Siren,
    description: "Correlated systemic incidents",
  },
  {
    label: "AI Copilot",
    href: "/dashboard/support-dashboard/ai-copilot",
    icon: BrainCircuit,
    description: "Evidence-grounded investigations",
  },
  {
    label: "AI Quality",
    href: "/dashboard/support-dashboard/ai-quality",
    icon: BarChart3,
    description: "Resolution & playbook analytics",
  },
  {
    label: "AI Knowledge",
    href: "/dashboard/support-dashboard/ai-knowledge",
    icon: BookOpen,
    description: "Human-reviewed learning drafts",
  },
  {
