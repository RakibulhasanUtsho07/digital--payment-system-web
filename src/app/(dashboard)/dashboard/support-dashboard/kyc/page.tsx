  ...
  return (
    <main className="space-y-6">
      ...
      >
        ...
        <div className="grid gap-3 xl:grid-cols-[1.55fr_1fr_1fr_1fr]">
          <div>
            <p className="mb-1.5 px-1 text-[9px] font-black uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">
              Search escalation
            </p>
                ...
                (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span
                        className={`shrink-0 rounded-full border px-2.5 py-1 text-[8px] font-black uppercase tracking-wide ${priorityStyle(
                          ticket.priority
                        )}`}
                      >
                        {
                      ...
                      >
                        ...
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              <p className="max-w-[170px] truncate font-black text-slate-900 dark:text-white">
                                {
                                  ticket.customerName
                                }
                              </p>
                    ...
                    <div className="space-y-5">
                      ...
                      >
                        <button
                          ...
                          className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-cyan-600 px-4 text-xs font-black text-white transition hover:bg-cyan-700 disabled:cursor-not-allowed disabled:opacity-45"
                        >
                          {actionMode ===
                          "status" ? (
