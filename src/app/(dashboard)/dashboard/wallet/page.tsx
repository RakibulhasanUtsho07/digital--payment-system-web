    ...
    useCallback(
      async (
        ...
        try {
          ...
          /*
           * TypeScript-safe wallet narrowing.
           */
  ...
  const handleFundsSubmit =
    async (
      ...
      try {
         ...
         * IMPORTANT:
         *
         * Narrow response.wallet before entering the
         * setWallet callback. This fixes TS18048:
         *
         * 'response.wallet' is possibly 'undefined'
         */
        const responseWallet =
          response.wallet;
